...
// Camera limits are round one's: any polar angle (the galaxy can be viewed
// from underneath) and a closest approach inside the disc. Round two's
// 12 degree clamp and 5.5 minimum were rejected by eye as too limiting; the
// dust plane fade (dust.ts) covers the edge-on crossing instead.
